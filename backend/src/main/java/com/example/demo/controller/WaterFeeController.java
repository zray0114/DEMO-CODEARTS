...
import com.example.demo.entity.WaterFee;
import com.example.demo.mapper.WaterFeeMapper;
...
public class WaterFeeController {
    ...
    public ResponseEntity<Map<String, Object>> list(
        ...
        Page<WaterFee> pageParam = new Page<>(page, size);
        ...
        wrapper.orderByDesc(WaterFee::getPaymentDate);
        Page<WaterFee> result = waterFeeMapper.selectPage(pageParam, wrapper);
    ...
    @PutMapping("/{id}")
    public ResponseEntity<WaterFee> update(
    ...
    public ResponseEntity<Map<String, Object>> delete(@PathVariable Long id) {
        int rows = waterFeeMapper.deleteById(id);
    ...
    public ResponseEntity<List<Map<String, Object>>> statistics(
        ...
        List<WaterFee> fees = waterFeeMapper.selectList(wrapper);
